...
#include "geometry_msgs/msg/detail/polygon_instance__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::PolygonInstance;
    is_plain =
      (
...
static size_t _PolygonInstance__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PolygonInstance(full_bounded, is_plain, 0);
...
{
  return &geometry_msgs::msg::typesupport_fastrtps_cpp::_PolygonInstance__handle;
}
