...
static const _VelocityStamped_type_support_symbol_names_t _VelocityStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, geometry_msgs, msg, VelocityStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, geometry_msgs, msg, VelocityStamped)),
  }
};
...
{
  return &::geometry_msgs::msg::rosidl_typesupport_cpp::VelocityStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, geometry_msgs, msg, VelocityStamped)() {
  return get_message_type_support_handle<geometry_msgs::msg::VelocityStamped>();
}
