...
static const _SetMap_Request_type_support_symbol_names_t _SetMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_msgs, srv, SetMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_msgs, srv, SetMap_Request)),
  }
};
...
{
  return &::nav_msgs::srv::rosidl_typesupport_cpp::SetMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav_msgs, srv, SetMap_Request)() {
  return get_message_type_support_handle<nav_msgs::srv::SetMap_Request>();
}
...
static const _SetMap_Response_type_support_symbol_names_t _SetMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_msgs, srv, SetMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_msgs, srv, SetMap_Response)),
  }
};
...
{
  return &::nav_msgs::srv::rosidl_typesupport_cpp::SetMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav_msgs, srv, SetMap_Response)() {
  return get_message_type_support_handle<nav_msgs::srv::SetMap_Response>();
}
...
static const _SetMap_type_support_symbol_names_t _SetMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_msgs, srv, SetMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_msgs, srv, SetMap)),
  }
};
...
{
  return &::nav_msgs::srv::rosidl_typesupport_cpp::SetMap_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, nav_msgs, srv, SetMap)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<nav_msgs::srv::SetMap>();
}
